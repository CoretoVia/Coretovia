...
| реда в дълга | **103** | `npm run dalg` · `docs/registar-na-dalga.json` |
| — отворени | **51** | същото |
| — затворени | **51** | същото |
...
| [`2026-09-14.md`](../docs/izvori/dni/2026-09-14.md) | думи-ден · запис | 2026-09-14 · неговите думи · ДОСЛОВНО |
...
| [`2026-09-14.md`](../docs/dnevnik/2026-09-14.md) | запис-ден · запис | 2026-09-14 · залепеният хедър · един скролер вместо два |
...
**Броено при последното писане на картата:** 189 документа в 15 папки.
