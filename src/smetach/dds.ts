 ...
 * (правило 16), но НЕ е движение: истината е една — редът на месеца в `dds`.
 *
...
export const IZVEDENITE_NA_DDSA: readonly IzvedenaKolona[] = Object.freeze([
  ...
  },
  {
    ...
    ime: 'остатък',
    pomosht: pomosht(
      'Колко остава да се внесе или да ти върнат. В лентата горе стои НАТРУПАНОТО през всички месеци — сборът на месечните остатъци; в реда на един месец стои неговият собствен: дължимо минус платено.',
      'дължимо − платено',
    ),
  },
]);
...
export interface MesetsNaDdsa {
  ...
  /** сумата, с която редът влиза в Сметки · разходът е отрицателен (правило 16) */
