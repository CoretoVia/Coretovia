...
const KESH_KOLONI: readonly Kolona[] = [
  ...
  },
  {
    ...
    vid: 'evro',
    pomosht: pomosht(
      'Колко е изтеглено в брой с КАРТАТА за месеца, по нейното извлечение (негово: „от Карта само"). Сверява се с даденото: дадено ↔ изтеглено, и разликата се записва и когато е нула.',
      'сума в евро · пише се · от извлечението на Картата · сверка: дадено ↔ изтеглено',
    ),
    zadalzhitelna: false,
    zatvorena: false,
    nashaDuma: true,
