 ...
 *
 * И ЕДНА ГРАНИЦА, НАМЕРЕНА НА 14.09: `vika` брои и ОБЯВЯВАНЕТО. Ред в интерфейс
 * (`vazstanovi(tekst: string): Promise<string>;`) изглежда точно като извикване и
 * мина за такова при затварянето на ДЛ-Н1 — а извикването беше на друго място.
 * Там, където има значение ПРЕЗ КОЙ обект се вика, се пише `broy` с шаблон
 * `\\.име\\(` — точката изключва и обявяването, и едноименната функция в
 * друг файл.
 *
